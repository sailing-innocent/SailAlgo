# Hugging Face 
"""
python samples/transformer/run_image_classification.py `
     --dataset_name beans `
     --output_dir data/mid/beans_outputs/ `
     --remove_unused_columns False `
     --label_column_name labels `
     --model_name_or_path data/pretrained/vit/vit-base-patch16-224-in21k `
     --do_train `
     --do_eval `
     --learning_rate 2e-5 `
     --num_train_epochs 5 `
