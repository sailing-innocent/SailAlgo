...
@openai_client(os.getenv("ALIYUN_DEEPSEEK_ENDPOINT"), os.getenv("ALIYUN_DEEPSEEK_API_KEY"))
def request_prompt(endpoint, api_key, prompt: str = "", model: str = "deepseek-r1-distill-qwen-32b") -> str:
    ...
    completion = client.chat.completions.create(
        model="deepseek-r1-distill-qwen-32b",  # 此处以 deepseek-r1-distill-qwen-7b 为例，可按需更换模型名称。
        messages=[
